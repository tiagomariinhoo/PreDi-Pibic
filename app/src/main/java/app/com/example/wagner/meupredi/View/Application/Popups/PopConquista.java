...
public class PopConquista extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!Double.isNaN(paciente.getPeso()) && !Double.isNaN(paciente.getAltura())) {
            ...
            if(Double.isNaN(paciente.getPeso())){
                Toast.makeText(getApplicationContext(),"Favor digitar um peso válido para melhores recomendações",Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(getApplicationContext(),"Favor digitar uma altura válida para melhores recomendações",Toast.LENGTH_LONG).show();
            }
            finish();
        }
