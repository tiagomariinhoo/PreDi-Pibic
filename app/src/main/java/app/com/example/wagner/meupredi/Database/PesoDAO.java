...
public class PesoDAO {
    ...
    public static Task<Void> createPeso(Paciente paciente){
        ...
        PesoClass peso = new PesoClass(new Date(), paciente.getPeso(), paciente.getCircunferencia(), 0, paciente.getEmail());
        return getRef(paciente.getEmail()).document(peso.getDatePesoString()).set(peso);
    }

    public static Task<Void> updatePeso(PesoClass peso){
    ...
    public static Task<Void> deletePeso(PesoClass peso){
        peso.setFlagPeso(0);
